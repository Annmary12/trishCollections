            ...
            <div class="col-md-3 text-center" >
                ...
                <button class="navbar-toggler navbar-toggler-right" type="button" data-toggle="collapse" data-target="#navbarNav1" aria-controls="navbarNav1" aria-expanded="false" aria-label="Toggle navigation">
                 ...
                 <div class="collapse navbar-collapse" id="navbarNav1">
                    ...
                    <li class="nav-item waves-effect waves-light myTab">
                        <a class="nav-link active" data-toggle="tab" href="#" role="tab"> <b>Home</b></a>
                    </li><div class="clearfix"></div>
                    <li class="nav-item waves-effect waves-light myTab">
                        <a class="nav-link" data-toggle="tab" href="#" role="tab"><b> Catalog</b></a>
                    </li><div class="clearfix"></div>
                    <li class="nav-item waves-effect waves-light myTab">
                        <a class="nav-link" data-toggle="tab" href="#" role="tab"><b> Blog</b></a>
                    </li>

                     <li class="nav-item waves-effect waves-light myTab">
                        <a class="nav-link" data-toggle="tab" href="#" role="tab"><b> About Us</b></a>
                    </li><div class="clearfix"></div>
                    <hr>
                    </ul>
                </div>
